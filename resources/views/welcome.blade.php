...
@section('title', 'CO.DE - Soluzioni Digitali per la Compliance Aziendale')
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center flex-shrink-0">
                    <div class="w-48 h-12 flex items-center">
                        <img src="{{ asset('images/logo-code.png') }}" 
                             alt="CO.DE Logo" 
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white bg-opacity-25 backdrop-blur-lg rounded-xl p-8 text-white border border-white border-opacity-40 card-hover">
                    <div class="text-center">
                        ...
                        <a href="{{ route('register') }}" class="block bg-gradient-to-r from-aqua to-tiffany hover:from-tiffany hover:to-celeste text-white py-3 px-6 rounded-lg font-semibold btn-professional">
                            Inizia Ora
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white bg-opacity-30 backdrop-blur-lg rounded-xl p-8 text-white border-2 border-code-accent relative shadow-2xl">
                    <div class="text-center relative">
                        ...
                        <a href="{{ route('register') }}" class="block bg-gradient-to-r from-code-accent to-acquamarina hover:from-acquamarina hover:to-celeste text-white py-3 px-6 rounded-lg font-semibold btn-professional">
                            Scegli Professional
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white bg-opacity-25 backdrop-blur-lg rounded-xl p-8 text-white border border-white border-opacity-40 card-hover">
                    <div class="text-center">
                        ...
                        <a href="{{ route('register') }}" class="block bg-gradient-to-r from-tiffany to-code-accent hover:from-code-accent hover:to-acquamarina text-white py-3 px-6 rounded-lg font-semibold btn-professional">
                            Contatta Vendite
                        </a>
                    </div>
                </div>
