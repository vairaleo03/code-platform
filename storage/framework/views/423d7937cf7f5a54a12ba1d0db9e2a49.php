<?php $__env->startSection('title', 'Registrazione - CO.DE Platform'); ?>
...
<div class="min-h-screen code-gradient flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl w-full">
        ...
        <div class="bg-white rounded-2xl card-shadow overflow-hidden" x-data="initPlanSelection()">
            ...
            <!-- Registration Form -->
            <form method="POST" action="<?php echo e(route('register')); ?>" class="p-8">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        Hai già un account? 
                        <a href="<?php echo e(route('login')); ?>" class="text-code-blue hover:text-code-light-blue font-medium">
                            Accedi qui
                        </a>
                    </p>
                </div>
